...
PATH_TO_CONFIG = Path(os.getenv("CONFIG", r'D:\Jetbrains\Python\Projects\solar_irradiance_nowcasting\configs\dni_only\LSTM_DNI_STATION_ECMWF_CELL_1.json'))
...
PKL_PROCESSED_ECMWF = PATH_PROCESSED_DATA / 'ecmwf' / "ecmwf_fc_2020_to_2025_minutely_interpolated_tcc_cell_85.pkl"
GAP_THRESHOLD = 1
"""
